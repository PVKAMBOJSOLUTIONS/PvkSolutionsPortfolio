...
export class AboutComponent implements OnInit {
  ...
  aboutParagraphs = [
    "I'm a passionate Full Stack Developer with expertise in .NET and Angular. With over 3 years of experience in building enterprise-level applications, I specialize in creating scalable, maintainable, and user-friendly web solutions.",
